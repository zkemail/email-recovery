    ...
    BaseTest
{
    ...
    function getAcceptanceEmailProofData(
        ...
        if (guardianType == GuardianType.MockEmailGuardian) {
            ...
            string memory proofFile = vm.readFile(
                string.concat(
                    vm.projectRoot(),
                    "/test/bin/email-acceptance-proof.json"
                )
            );
    ...
    function getAcceptanceEmailNrProofData(
        ...
        string memory proofFile = vm.readFile(
            string.concat(
                vm.projectRoot(),
                "/test/bin/email-nr-acceptance-proof.json"
            )
        );
    ...
    function getRecoveryEmailProofData(
        ...
        if (guardianType == GuardianType.EmailGuardian) {
            string memory proofFile = vm.readFile(
                string.concat(
                    vm.projectRoot(),
                    "/test/bin/email-recovery-proof.json"
                )
            );
    ...
    function getRecoveryEmailNrProofData(
        ...
        string memory proofFile = vm.readFile(
            string.concat(
                vm.projectRoot(),
                "/test/bin/email-nr-recovery-proof.json"
            )
        );
