...
library EnumerableGuardianMap {
    ...
    struct Bytes32ToGuardianMap {
        // Storage of keys
        EnumerableSet.Bytes32Set _keys;
        mapping(bytes32 key => GuardianStorage) _values;
    }
     ...
     */
    function set(
        Bytes32ToGuardianMap storage map,
        bytes32 key,
     ...
     */
    function remove(Bytes32ToGuardianMap storage map, bytes32 key) internal returns (bool) {
     ...
     */
    function removeAll(Bytes32ToGuardianMap storage map, bytes32[] memory guardianKeys) internal {
     ...
     * be quite expensive.
     */
    function keys(Bytes32ToGuardianMap storage map) internal view returns (bytes32[] memory) {
