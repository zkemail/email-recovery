...
contract ZkEmailRecovery_recoverySubjectTemplates_Test is UnitBase {
    function setUp() public override {
        super.setUp();
    }

    function test_RecoverySubjectTemplates_Succeeds() public view {
        string[][] memory templates = zkEmailRecovery.recoverySubjectTemplates();
