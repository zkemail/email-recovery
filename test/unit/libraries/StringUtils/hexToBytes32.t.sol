...
contract StringUtils_HexToBytes32_Test is UnitBase {
    ...
    function test_HexToBytes32_RevertWhen_InvalidHexPrefix() public {
        ...
        // remove 0x prefix
        strings.slice memory s = hashString.toSlice();
        s.split("0x".toSlice());

        vm.expectRevert("invalid hex prefix");
        StringUtils.hexToBytes32(s.toString());
    }
    ...
    function test_HexToBytes32_RevertWhen_InvalidHexStringLength_ZeroShortHash() public {
    ...
    function test_HexToBytes32_RevertWhen_InvalidHexChar_SingleCapitalLetter() public {
    ...
    function test_HexToBytes32_RevertWhen_MixedCaseHex() public {
        string memory mixedCaseHashString =
            "0x509D286573e85F37b51F178c1cf8376452ba746b093A149f9d733c145539771d";

        vm.expectRevert("invalid hex char");
        StringUtils.hexToBytes32(mixedCaseHashString);
    }
