...
contract EmailRecoverySubjectHandler_acceptanceSubjectTemplates_Test is UnitBase {
    function setUp() public override {
        super.setUp();
    }

    function test_AcceptanceSubjectTemplates_Succeeds() public view {
        string[][] memory templates = emailRecoveryHandler.acceptanceSubjectTemplates();
