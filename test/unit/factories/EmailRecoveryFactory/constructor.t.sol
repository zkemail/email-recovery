...
contract EmailRecoveryFactory_constructor_Test is UnitBase {
    ...
    function test_Constructor_RevertWhen_InvalidVerifier() public {
        ...
        new EmailRecoveryFactory(invalidVerifier, address(emailAuthImpl), address(eoaVerifier), address(eoaAuthImpl));
    }
    ...
    function test_Constructor_RevertWhen_InvalidEmailAuthImpl() public {
        ...
        new EmailRecoveryFactory(address(verifier), invalidEmailAuth, address(eoaVerifier), address(eoaAuthImpl));
    }

    function test_Constructor() public {
        EmailRecoveryFactory emailRecoveryFactory =
            new EmailRecoveryFactory(address(verifier), address(emailAuthImpl), address(eoaVerifier), address(eoaAuthImpl));
