...
import { GenericRecoveryManager } from "../GenericRecoveryManager.sol";
import { GuardianType } from "../libraries/EnumerableGenericGuardianMap.sol";

/**
 * @title UniversalGenericRecoveryModule
 ...
 */
contract UniversalGenericRecoveryModule is
    ...
    IUniversalEmailRecoveryModule
{
    ...
    function onInstall(bytes calldata data) external {
        ...
        (
            ...
            data, (address, bytes, bytes4, address[], uint256[], GuardianType[], uint256, uint256, uint256)
        );
